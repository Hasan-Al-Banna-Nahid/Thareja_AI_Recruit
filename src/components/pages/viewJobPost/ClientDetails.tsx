...
const ClientDetails = () => {
  const paragraphStyle = "text-base md:text-[18px] leading-[25px]";
  return (
    <div className="w-full lg:max-w-[398px] p-5 md:p-6 lg:px-[30px] lg:py-10 rounded-[20px] border border-[#97BCFF] bg-[#FBFCFF]">
      ...
      <div className="w-full flex items-center gap-2.5 mb-6 lg:mb-[30px]">
        ...
        <button className="p-2 md:p-2.5 rounded-full border border-[#005aff33] bg-white">
          <PencilSVG />
        </button>
      </div>

      <div className="w-full">
        <p className="mb-[14px] flex gap-2.5 items-center text-[18px] md:text-[20px] leading-normal tracking-[0.4px]">
          <Image
            width={19.99}
            height={20}
        ...
        <h3 className="mb-2 text-[18px] md:text-[20px] lg:text-[22px] leading-[30px] md:leading-[35px] lg:leading-[40px]">
          Job link
        </h3>
