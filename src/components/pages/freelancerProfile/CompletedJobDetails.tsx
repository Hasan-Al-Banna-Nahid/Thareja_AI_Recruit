  ...
  return (
    <>
      ...
      <div className="w-full flex items-center gap-3 mb-2">
        ...
        <span className="text-base md:text-[18px] leading-[25px] ">4.96</span>
      </div>
      <p className="text-[#A1A5AD] text-base md:text-[18px] leading-[25px] ">
        Apr 8, 2024 - May 3, 2024
      </p>

      <p className="text-[#525966] text-base md:text-[18px] leading-[25px] my-4">
        &quot;Amazing designer, will use again!&quot;
      </p>
      <div className="flex w-full max-w-[474px] gap-3 2xl:gap-[56px] ">
        <p className="text-[#525966] text-base md:text-[18px] leading-[25px]">
          $500.00
        </p>
      ...
      <div className="w-full flex items-center gap-3 mb-2">
        ...
        <span className="text-base md:text-[18px] leading-[25px] ">500</span>
      </div>
      <p className="text-[#A1A5AD] text-base md:text-[18px] leading-[25px] ">
        Apr 8, 2024 - May 3, 2024
      </p>
