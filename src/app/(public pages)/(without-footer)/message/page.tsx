...
const MessagePage = () => {
  return (
    ...
    <div className="text-[#30353E] pt-[100px] lg:pt-[130px] 2xl:pt-[185px] w-full mx-auto max-w-[1920px] h-[100vh] h-[100dvh] flex flex-col">
      <div className=" relative w-full gap-2.5 justify-between px-5 md:px-[30px] lg:px-[40px] xl:px-[50] 2xl:px-[60px] flex h-full">
        <People />
        <Conversation />
        <UserProfile />
      </div>
