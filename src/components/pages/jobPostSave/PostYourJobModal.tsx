  ...
  return active ? (
    <ReviewPostFieldModal>
      <div className=" w-full max-w-[694px] max-h-[95%] min-h-[250px] h-auto rounded-[20px] md:rounded-[30px] bg-white shadow-md ">
        <div className="overflow-y-auto relative px-[20px] md:p-[30px] md:px-[51px] max-h-[100%] w-full h-full">
          {/* ====== cancel button ======= */}
          <button
          ...
          <div className="w-full flex flex-col items-center justify-center gap-5 md:gap-7">
            ...
            />
            <h2 className="text-center text-[22px] md:text-[25px] lg:text-[27px] leading-[36px] md:leading-[40px]">
              What happens after you post your job?
            </h2>
            <p className="text-[18px] leading-[25px] text-center">
