  ...
  return (
    <div className="w-full px-6 md:px-[35px] lg:px-[50px]">
      <label
        ...
        className="text-[18px] md:text-[20px] lg:text-[22px] leading-[25px] flex items-center justify-between gap-5"
      >
        <span>Add automatic weekly payments for the talent (optional)</span>
        <DownArrowSVG className={`duration-200 ${active && "rotate-180"}`} />
      </label>
      {active && (
        <div className="w-full flex flex-col gap-6 mt-5 lg:mt-[30px] p-5 md:p-6 lg:p-7 xl:p-[30px] rounded-[20px] border bg-[#005aff05] border-[#005aff1a]">
          ...
          <Link
            href="#"
            className="text-[#005AFF] text-[18px] md:text-[20px] lg:text-[22px] leading_normal"
          >
            How does it work?
          </Link>
          <p className=" text-[18px] md:text-[20px] lg:text-[22px] leading_normal">
          ...
          <div className="input-item flex gap-[10px] items-center">
            <input
              ...
              placeholder="$0.00"
              // value={`$${to}`}
              className="text-[18px] md:text-[20px] lg:text-[22px] leading_normal max-w-[300px] border border-gray-300 rounded-[6px] p-[10px] focus:outline-none focus:border-[#005AFF] text-end"
            />
          </div>
        </div>
      )}
    ...
    <div className="w-full px-6 md:px-[35px] lg:px-[50px]">
      ...
      {active && (
        <div className="w-full mt-5 lg:mt-[30px] p-5 md:p-6 lg:p-7 xl:p-[30px] rounded-[20px] border bg-[#005aff05] border-[#005aff1a]">
          <p className=" text-[18px] md:text-[20px] lg:text-[22px] leading_normal mb-10">
...
const FreelancerFAQ = () => {
  return (
    <div className="py-6 md:py-[35px] lg:py-[50px] border border-[#0000001f] rounded-[20px]">
