    ...
    >
      ...
      {activeInviteConfirmModal ? (
        ...
        >
          ...
          <h3 className="text-[22px] md:text-[25px] lg:text-[27px] leading-[35px] md:leading-[40px] text-center mt-[30px]">
        ...
        >
          ...
          <div className="bg-[#005aff08] mb-5 md:mb-[28px] rounded-[12px] py-[10px] px-4 md:px-[18px] w-full flex items-center justify-between gap-5">
            <h3 className="text-[22px] md:text-[25px] lg:text-[27px] leading-[30px] md:leading-[40px] text-[#30353E]">
          ...
          <div className="w-full">
            <label
              className="text-[18px] md:text-[20px] leading-normal tracking-[0.4px] mb-2.5 block"
              htmlFor="coworkers-email"
            >
              Email Addresses
            </label>
            <input
          ...
          <div className="w-full flex items-center justify-end gap-[14px]">
            ...
            <button
              className="py-2.5 md:py-3 px-5 md:px-8 lg:py-[16px] lg:px-[40px] rounded-[100px] bg-[#005AFF] text-white"
              onClick={(e) => {
                e.stopPropagation();
                setActiveInviteConfirmModal(true);
              }}
