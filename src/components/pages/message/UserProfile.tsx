  ...
  return (
    <div className="relative w-full max-w-[420px]  p-5 pr-1  md:p-6 md:pr-1 lg:pr-1 lg:p-[30px] bg-[#005aff0a] rounded-[30px] h-full overflow-hidden">
      ...
      <div className="w-full custom_scrollbar overflow-y-auto h-full pr-4 md:pr-5 lg:pr-[26px]">
        ...
        <h5 className="mx-auto text-center text-[18px] md:text-[20px] lg:text-[22px] leading_normal mb-[14px]">
          Ali D.
        </h5>
        <p className="text-base md:text-[18px] leading-[25px]  flex items-center gap-[12px] justify-center w-full mb-1.5">
          <SuitcaseSVG /> <span>ABC Technologies LLP</span>
        </p>

        <p className="text-base md:text-[18px] leading-[25px]  flex items-center gap-[12px] justify-center w-full mb-6 md:mb-7 lg:mb-[30px] mx-auto">
          <ClockSVG /> <span>ABC Technologies LLP</span>
        </p>

        <Link
          href="#"
          className="text-base md:text-[18px] leading-[25px]  flex items-center gap-[12px] justify-center w-full mb-6 md:mb-7 lg:mb-[30px] mx-auto text-[#005AFF]"
        >
...
const UserProfile = () => {
  ...
  return (
    <div
      ...
      className={`duration-500 w-full flex shadow-2xl 2xl:shadow-none justify-end z-50 lg:pr-5 xl:pr-[25px] 2xl:pr-0 max-w-[420px] xl:max-w-[445px] 2xl:max-w-[420px]  bg-white 2xl:bg-transparent rounded-[30px]  h-full 2xl:pl-0 2xl:translate-x-0 translate-x-[110%]  absolute top-0 right-0  2xl:relative ${
