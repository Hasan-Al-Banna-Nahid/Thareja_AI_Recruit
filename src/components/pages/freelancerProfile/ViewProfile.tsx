...
const OpenToOffersQuestionModal = () => {
  ...
  return (
    <div className="flex items-center text-base md:text-[18px] leading-[25px] mb-2.5 gap-2">
...
const NewLabelHoverModal = () => {
  const [activeQuestionModal, setActiveQuestionModal] = useState(false);
  return (
    <div className="flex items-center gap-1 text-base md:text-[18px] leading-[25px] mb-2.5 text-[#A1A5AD]">
      ...
      <div className="relative w-auto">
        ...
        >
          ...
          <p className="text-[#30353E] mb-2.5 text-[18px] md:text-[20px] lg:text-[22px] leading-[30px] md:leading-[35px] lg:leading-[40px]">
            Contract-to-hire
          </p>
          <p className="text-[#30353E] text-base md:text-[18px] leading-[25px]">
...
const ViewProfile = () => {
  ...
  return (
    <>
      ...
      <div className="mx-[14px] flex flex-col gap-1.5 mt-1.5">
        <p className="text-base md:text-[18px] leading-[25px]">UX/UI Design</p>
        <p className="text-base md:text-[18px] leading-[25px]">Mobile Design</p>
        <button className="w-full  md:max-w-[350px] flex items-center justify-between text-[18px] md:text-[20px] leading-[25px] py-1.5 px-5 rounded-[100px] border border-[#0059ff33] text-[#005AFF]">
          <span>All work</span>{" "}
          <span>
            <ArrorRightSVG />
          </span>
      ...
      <div className="w-full flex items-start justify-between">
        <div className="">
          <p className="text-[18px] md:text-[20px] leading_normal tracking-[0.4px] text-[#005AFF] mb-1">
            30
          </p>
          <p className="text-[18px] md:text-[20px] leading_normal tracking-[0.4px] text-[#A1A5AD]">
            Total Jobs
          </p>
        </div>
        <div className="">
      ...
      <h3 className="mb-1 text-[22px] md:text-[25px] lg:text-[27px] leading-[35px] md:leading-[40px] mt-6 md:mt-8 lg:mt-[38px]">
        Hours per week
      </h3>
      ...
      <p className="text-base md:text-[18px] leading-[25px] mb-1 text-[#A1A5AD]">
        2017-2018
      </p>
      <p className="text-base md:text-[18px] leading-[25px] mb-1">
        Associate&apos;s degree, professional print design | Skills Development
        ...
        <div>
          ...
          <div className="relative w-auto mb-1">
            <p
              ...
              className="z-10 cursor-pointer text-base md:text-[18px] leading-[25px] flex items-center gap-2 "
            >
              <CrownSVG />{" "}
          ...
          <div className="relative w-auto">
            <p
              ...
              onMouseLeave={() => setActiveModal(null)}
              className="z-10 cursor-pointer text-base md:text-[18px] leading-[25px] flex items-center gap-2 text-[#FF9314]"
            >
