...
const ViewJobPostJobDetails = () => {
  ...
  return (
    <>
        ...
        <div className="w-full lg:max-w-[1088px] mb-10 lg:mb-0">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-wrap gap-[14px]">
              <p className="text-[18px] md:text-[20px] leading-[25px] py-3.5 md:py-4 px-[35px] md:px-10 rounded-[100px] bg-[#dde3e766] text-[#525966cc]">
                Mobile App Design
              </p>
              <p className="text-[18px] md:text-[20px] leading-[25px] py-3.5 md:py-4 px-[35px] md:px-10 rounded-[100px] bg-[#dde3e766] text-[#525966cc]">
                Website Design
      ...
      <section className="w-full p-[35px] md:p-[40px] lg:p-[45px] xl:p-[50px] border border-[#005aff99] rounded-[20px] mt-10 md:mt-[50px] lg:mt-[60px]">
        <h2 className="text-[32px] md:text-[text-36px] lg:text-[40px] leading-normal tracking-[-1.2px] mb-5 md:mb-6 lg:mb-[30px] ">
