...
const ViewJobPostNavigator = ({ activeId, jobTitle }: PropsType) => {
  ...
  return (
    <section className="w-full">
      <h1 className="text-[30px] lg:text-[60px] tracking-[-1.8px] text-[#30353E] mb-[30px] md:mb-[40px]">
        UX/UI Design
      </h1>
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap lg:grid lg:grid-cols-2 gap-y-1 md:gap-y-4 2xl:flex 2xl:flex-nowrap mb-[50px] md:mb-[64px] ">
        ...
        >
          <div className="view-jobpost-link-shadow absolute top-[50%] z-50 translate-y-[-50%] left-0 flex items-center justify-center w-[70px] md:w-[80px] h-[70px] md:h-[80px] bg-gradient-to-tr from-[#005AFF] to-[#01D18F] rounded-full">
            <div className=" w-[66px] h-[66px] md:w-[74px] md:h-[74px] bg-white rounded-full flex items-center justify-center">
              <span className="text-[25px] md:text-[27px]">1</span>
            </div>
          </div>
          <div
            className={`rounded-e-[10px] md:rounded-none w-full py-2  z-10  md:py-2.5 pl-[80px] md:pl-[70px] lg:pl-[80px] mx-5  ${
              activeId === 1
                ? "bg-[#005AFF] text-white"
                : "text-[#005AFF] bg-[#005aff4d] "
            }`}
          >
            <p className="text-[18px] md:text-[20px] lg:text-[22px] leading-[35px] ">
              View Job Post
            </p>
          </div>
          <div className="hidden md:block absolute top-0 z-40 right-[-45px] md:right-[-15px] w-[75px] -ml-[15px] h-[75px] rounded-full bg-white"></div>
        </Link>
        {/* ======== FIRST LINK ENDS ========= */}
        ...
        >
          ...
          <div
            className={`w-full rounded-e-[10px] md:rounded-none  py-2  z-10  md:py-2.5 pl-20 md:pl-[30px] lg:pl-10 mx-5 ${
              activeId === 2
                ? "bg-[#005AFF] text-white"
                : "text-[#005AFF] bg-[#005aff4d] "
            } `}
          ...
          <div className="hidden md:block absolute top-0 z-40 right-[-45px] 2xl:right-[-15px] w-[75px] -ml-[15px] h-[75px] rounded-full bg-white"></div>
        </Link>
        {/* ======== SECOND LINK ENDS ========= */}
        ...
        >
          ...
          <div
            className={`rounded-e-[10px] md:rounded-none w-full py-2  z-10  md:py-2.5 pl-20 md:pl-[70px] lg:pl-20 2xl:pl-10 mx-5 ${
              activeId === 3
                ? "bg-[#005AFF] text-white"
                : "text-[#005AFF] bg-[#005aff4d] "
            } `}
          >
            <p className="text-[18px] leading-[19px] md:text-[20px] lg:text-[22px]]">
              Review Proposals (60)
            </p>
        ...
        >
          ...
          <div
            className={`rounded-e-[10px] md:rounded-none w-full py-2  z-10  md:py-2.5 pl-[80px] md:pl-[30px] lg:pl-10 mx-5 ${
              activeId === 4
                ? "bg-[#005AFF] text-white"
                : "text-[#005AFF] bg-[#005aff4d] "
            }`}
          ...
          <div className="hidden md:block absolute top-0 z-40 right-[-45px] 2xl:right-[-30px] w-[75px] -ml-[15px] h-[75px] rounded-full bg-white"></div>
        </Link>
        {/* ======== FOURTH LINK ENDS ========= */}
      </div>
    </section>
