  ...
  return (
    <>
      <div className="w-full hidden md:flex justify-start relative mb-5">
        <div className="w-auto bg-white h-full z-20">
          <button
            ...
            className={`pb-1.5 border-b text-[18px] leading-[25px] ${
              active === "SEARCH"
      ...
      <div className="rounded-[10px] relative mb-5 w-full md:hidden z-[99999999]">
        ...
        >
          <span className="pointer-events-none text-[18px] leading-[25px]">
            {filteredItem?.label}
          </span>
        ...
        >
          {dropDownItems.map((item) => (
            <li
              ...
              className={`pl-2.5 ml-2.5  md:pl-[14px]  duration-200 cursor-pointer py-0.5 my-1 text-[18px] leading-[25px] ${
